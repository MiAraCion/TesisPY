...
# ==========================================
# CONFIGURACION (especifica del anio 2022)
# ==========================================

ANIO = 2022
BASE_DIR = Path(__file__).resolve().parent
OUTPUT_FILE = BASE_DIR / "endes_filtrada_ml_2022.csv"

# Nombres de archivo tal como existen en las carpetas de este anio
ARCHIVO_1631 = "REC0111.csv"
ARCHIVO_1632 = "RE223132.csv"
ARCHIVO_1633 = "REC41.csv"
ARCHIVO_1635 = "RE516171.csv"
ARCHIVO_1638 = "RECH5.csv"
ARCHIVO_1640 = "CSALUD01.csv"
...
def detectar_separador(ruta_archivo):
    """Detecta si el CSV usa ',' o ';' (en 2022 no todos los archivos usan el mismo)"""
